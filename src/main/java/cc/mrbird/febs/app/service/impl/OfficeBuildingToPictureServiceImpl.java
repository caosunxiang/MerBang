...
public class OfficeBuildingToPictureServiceImpl extends ServiceImpl<OfficeBuildingToPictureMapper,
        OfficeBuildingToPicture> implements IOfficeBuildingToPictureService {
    ...
    @Override
    public IPage<OfficeBuildingToPicture> findOfficeBuildingToPictures(QueryRequest request,
